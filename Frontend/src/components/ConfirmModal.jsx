...
function ConfirmModal({ isOpen, onClose, onConfirm, title, message, confirmText = "Confirm", cancelText = "Cancel", type = "danger" }) {
  ...
  const typeStyles = {
    ...
    info: {
      button: "bg-[#05699e] hover:bg-[#044d73] focus:ring-[#05699e]",
      icon: (
        <svg className="w-6 h-6 text-[#05699e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`flex-1 px-4 py-2.5 text-sm font-medium text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors ${style.button}`}
              >
                {confirmText}
              </button>
            </div>
